...
class AwardCategoriesWidget(QWidget):
    ...
    def apply_preset(self):
        ...
        if "IAAF" in preset:
            ...
            categories_5y = [
                ("M_Sub19", "M Sub-19", "M", 0, 19),
                ("M_20-24", "M 20-24", "M", 20, 24),
                ("M_25-29", "M 25-29", "M", 25, 29),
                ("M_30-34", "M 30-34", "M", 30, 34),
                ("M_35-39", "M 35-39", "M", 35, 39),
                ("M_40-44", "M 40-44", "M", 40, 44),
                ("M_45-49", "M 45-49", "M", 45, 49),
                ("M_50-54", "M 50-54", "M", 50, 54),
                ("M_55-59", "M 55-59", "M", 55, 59),
                ("M_60+", "M 60+", "M", 60, None),
                ("F_Sub19", "F Sub-19", "F", 0, 19),
                ("F_20-24", "F 20-24", "F", 20, 24),
                ("F_25-29", "F 25-29", "F", 25, 29),
                ("F_30-34", "F 30-34", "F", 30, 34),
                ("F_35-39", "F 35-39", "F", 35, 39),
                ("F_40-44", "F 40-44", "F", 40, 44),
                ("F_45-49", "F 45-49", "F", 45, 49),
                ("F_50-54", "F 50-54", "F", 50, 54),
                ("F_55-59", "F 55-59", "F", 55, 59),
                ("F_60+", "F 60+", "F", 60, None),
                ("X_Sub19", "X Sub-19", "X", 0, 19),
                ("X_20-24", "X 20-24", "X", 20, 24),
                ("X_25-29", "X 25-29", "X", 25, 29),
                ("X_30-34", "X 30-34", "X", 30, 34),
                ("X_35-39", "X 35-39", "X", 35, 39),
                ("X_40-44", "X 40-44", "X", 40, 44),
                ("X_45-49", "X 45-49", "X", 45, 49),
                ("X_50-54", "X 50-54", "X", 50, 54),
                ("X_55-59", "X 55-59", "X", 55, 59),
                ("X_60+", "X 60+", "X", 60, None),
            ]
            ...
            categories_10y = [
                ("M_Sub19", "M Sub-19", "M", 0, 19),
                ("M_20-29", "M 20-29", "M", 20, 29),
                ("M_30-39", "M 30-39", "M", 30, 39),
                ("M_40-49", "M 40-49", "M", 40, 49),
                ("M_50-59", "M 50-59", "M", 50, 59),
                ("M_60+", "M 60+", "M", 60, None),
                ("F_Sub19", "F Sub-19", "F", 0, 19),
                ("F_20-29", "F 20-29", "F", 20, 29),
                ("F_30-39", "F 30-39", "F", 30, 39),
                ("F_40-49", "F 40-49", "F", 40, 49),
                ("F_50-59", "F 50-59", "F", 50, 59),
                ("F_60+", "F 60+", "F", 60, None),
                ("X_Sub19", "X Sub-19", "X", 0, 19),
                ("X_20-29", "X 20-29", "X", 20, 29),
                ("X_30-39", "X 30-39", "X", 30, 39),
                ("X_40-49", "X 40-49", "X", 40, 49),
                ("X_50-59", "X 50-59", "X", 50, 59),
                ("X_60+", "X 60+", "X", 60, None),
            ]
